...
class AddPostForm(forms.ModelForm):
    # title = forms.CharField(label='Заголовок', validators=[MinLengthValidator(5, message='Заголовок має містити
    # хоча б 5 символів'), MaxLengthValidator(100, message='Заголовок має містити максимум 100 символів')],
    # widget=forms.TextInput(attrs={'class': 'form-input'}), error_messages={'required': 'Публікація має містити
    # заголовок'}) # slug = forms.SlugField(max_length=255, label='URL', allow_unicode=True) content =
